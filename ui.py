...
import psutil
from app_profile import ASSISTANT_NAME, ASSISTANT_FULL_NAME, ASSISTANT_VERSION, FOOTER_BRAND
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle(f"{ASSISTANT_NAME} — {ASSISTANT_VERSION}")
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge(ASSISTANT_VERSION, C.PRI_DIM))
        lay.addStretch()
        ...
        mid.addWidget(title)
        sub = QLabel(ASSISTANT_FULL_NAME)
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl(FOOTER_BRAND))
        lay.addStretch()
        lay.addWidget(_fl("© ProductiveMind.Ai", C.PRI_DIM))
        return w
